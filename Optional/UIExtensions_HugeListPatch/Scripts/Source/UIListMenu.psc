...
Function ResetMenu()
	...
	_entryName = Utility.CreateStringArray(1024, "")
	_entryId = Utility.CreateIntArray(1024, -1)
	_entryParent = Utility.CreateIntArray(1024, -1)
	_entryCallback = Utility.CreateIntArray(1024, -1)
	_entryChildren = Utility.CreateBoolArray(1024, -1)
	_premadeEntries = Utility.CreateStringArray(1024, "")
...
Event OnLoadMenu(string eventName, string strArg, float numArg, Form formArg)
	;string[] entries = Utility.CreateStringArray(1024)
	string[] entries = Utility.CreateStringArray(_entryBuffer)
